...
export default function AnnouncementCard({
  ...
  return (
    <Link
      ...
      className="flex h-full min-w-0 flex-col rounded-lg border border-line bg-white p-5 transition hover:border-primary hover:shadow-[0_2px_12px_rgba(37,110,244,0.1)]"
    >
